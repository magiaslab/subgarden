...
// Tag gtag (GA4) sempre caricato se c'è GA_ID, così Google lo rileva. Se usi GTM, non aggiungere GA4 nel container per evitare doppio invio.
const useGADirect = !!GA_ID;
